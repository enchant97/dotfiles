...
set -gx PATH //usr/local/sbin:/usr/local/bin:/usr/bin:/usr/bin/site_perl:/usr/bin/vendor_perl:/usr/bin/core_perl ~/.emacs.d/bin/ ~/.local/bin/ ~/.dotnet/ ~/.dotnet/tools/ ~/.local/share/gem/ruby/3.0.0/bin/
